...
import {
  LayoutDashboard, Users, ShieldCheck, ShoppingCart, TrendingUp,
  FileText, Settings, ArrowLeft, Award,
} from "lucide-react";
import logo from "../../assets/365cd6f2dd45be695d6550c45d6280e22785450e.png";

const SIDEBAR_NAV = [
  { label: "ESD Dashboard", icon: LayoutDashboard, path: "/esd-dashboard" },
  { label: "SME Portfolio", icon: Users, path: "/esd-dashboard/sme-portfolio" },
  { label: "Compliance & Spend", icon: ShieldCheck, path: "/esd-dashboard/compliance" },
  { label: "Procurement Integration", icon: ShoppingCart, path: "/esd-dashboard/procurement" },
  { label: "Impact & Outcomes", icon: TrendingUp, path: "/esd-dashboard/impact" },
  { label: "Reports", icon: FileText, path: "/esd-dashboard/reports" },
  { label: "Settings", icon: Settings, path: "/esd-dashboard/settings" },
];

export function EsdLayout() {
