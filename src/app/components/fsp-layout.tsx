...
import {
  LayoutDashboard, FolderOpen, Shield, Banknote, Brain,
  FileText, Settings, ArrowLeft,
} from "lucide-react";
import logo from "../../assets/365cd6f2dd45be695d6550c45d6280e22785450e.png";

const SIDEBAR_NAV = [
  { label: "Lending Dashboard", icon: LayoutDashboard, path: "/fsp-dashboard" },
  { label: "SME Lending Book", icon: FolderOpen, path: "/fsp-dashboard/lending-book" },
  { label: "Credit & Risk", icon: Shield, path: "/fsp-dashboard/credit-risk" },
  { label: "Loan Products", icon: Banknote, path: "/fsp-dashboard/loan-products" },
  { label: "Allyra Intelligence", icon: Brain, path: "/fsp-dashboard/allyra-intelligence" },
  { label: "Reports", icon: FileText, path: "/fsp-dashboard/reports" },
  { label: "Settings", icon: Settings, path: "/fsp-dashboard/settings" },
];

export function FspLayout() {
